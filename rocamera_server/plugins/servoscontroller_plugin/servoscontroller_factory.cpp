...
int servoscontroller_factory::init(QString strName, QString strDescription, bool bEnabled)
{
   Q_UNUSED(bEnabled);
   
    servoscontrollerWorker *manager = new  servoscontrollerWorker (strName,strDescription);
