...
public:
    explicit balltrackerWorker(const QString &strName, const QString &strDescription = 0, bool bEnabled = 0, QObject *parent = 0);
...
private: // Functions
    void drawCVPannel(Mat &image, QVector3D center);
