...
{
    0x18, STRING_DESCRIPTOR, // bLength, bDscType
    'L', 0x00, 'i', 0x00, 'n', 0x00, 'u', 0x00,
    'x', 0x00, ' ', 0x00, 'R', 0x00, 'o', 0x00,
	 'b', 0x00, 'o', 0x00, 't', 0x00,
};
__code byte stringDescriptor2[] =
{
    0x26, STRING_DESCRIPTOR,
    'U', 0x00, 'S', 0x00, 'B', 0x00, ' ', 0x00,
    'R', 0x00, 'o', 0x00, 'b', 0x00, 'o', 0x00,
    't', 0x00, ' ', 0x00, 'p', 0x00, 'r', 0x00,
    'o', 0x00, 't', 0x00, 'o', 0x00, 'c', 0x00,
	 'o', 0x00, 'l', 0x00,
};
...
void ProcessHIDRequest(void)
{
    ...
    if (bRequest == GET_DESCRIPTOR)
    {
        ...
        if (descriptorType == HID_DESCRIPTOR)
        {
            ...
            // HID descriptor.
            requestHandled = 1;
            outPtr = (__data byte *)&configDescriptor.HIDDescriptor;
