...
void statusWidget::connectToRobot()
{
    ...
    m_connection.connect("com.robot.roengines", "/engines", "com.robot.roengines", "encoderLeftChange", this, SLOT(onEncoderLeftChanged(int)));
    m_connection.connect("com.robot.roengines", "/engines", "com.robot.roengines", "encoderRightChange", this, SLOT(onEncoderRightChanged(int)));
}

int statusWidget::getRightSpeed()
{
    int                    ret = 0;
    QDBusInterface         robotIface("com.robot.roengines", "/engines", "com.robot.roengines", m_connection, this);
...
void statusWidget::onSetPressed()
{
    ...
    QDBusInterface roengines("com.robot.roengines", "/engines", "com.robot.roengines", m_connection, this);
