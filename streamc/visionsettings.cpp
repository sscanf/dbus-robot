...
visionSettings::visionSettings(QWidget *parent)
    ...
    connect(m_pSocket, &QIODevice::readyRead, this, &visionSettings::on_readyRead);
    connect(m_pSocket, &QAbstractSocket::connected, this, &visionSettings::on_connected);
    connect(m_pSocket, &QAbstractSocket::disconnected, this, &visionSettings::on_disconnected);

    connect(ui->highh, &QAbstractSlider::valueChanged, this, &visionSettings::on_highChanged);
    connect(ui->highs, &QAbstractSlider::valueChanged, this, &visionSettings::on_highChanged);
    connect(ui->highv, &QAbstractSlider::valueChanged, this, &visionSettings::on_highChanged);

    connect(ui->lowh, &QAbstractSlider::valueChanged, this, &visionSettings::on_lowChanged);
    connect(ui->lows, &QAbstractSlider::valueChanged, this, &visionSettings::on_lowChanged);
    connect(ui->lowv, &QAbstractSlider::valueChanged, this, &visionSettings::on_lowChanged);

    connect(ui->camBrightness, &QAbstractSlider::valueChanged, this, &visionSettings::on_cameraChanged);
    ...
    m_pTimer = new QTimer();
    connect(m_pTimer, &QTimer::timeout, this, &visionSettings::on_timeout);
    m_pTimer->start(1000);
